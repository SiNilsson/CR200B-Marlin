...
#define STRING_CONFIG_H_AUTHOR "SNilsson" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -8.7, 27.87, -1.8 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS), (Y_BED_SIZE/2), 20 }
